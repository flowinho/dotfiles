...
" Active relative line numbers to use motion counts more easily.
set relativenumber
...
" inside VIM - this is needed for onedark / dracula to be displayed appropriately.
" KEYBINDINGS {{{
" -----------------------------------------------------------------------
...
" Place colorscheme and syntax call last, to make sure PlugIns are read.
syntax enable
colorscheme dracula
